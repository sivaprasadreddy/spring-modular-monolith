...
class OrderRestControllerTests {
    ...
    void shouldGetOrderSuccessfully() throws Exception {
        ...
        OrderEntity order = orderService.createOrder(OrderMapper.convertToEntity(request));

        mockMvc.perform(get("/api/orders/{orderNumber}", order.getOrderNumber()))
    ...
    void shouldGetOrdersSuccessfully() throws Exception {
        CreateOrderRequest request = buildCreateOrderRequest();
        orderService.createOrder(OrderMapper.convertToEntity(request));
